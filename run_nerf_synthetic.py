...
def train():
    ...
    for i in trange(start, N_iters):
        ...
        unit_exp_loss = point_constraint_synthetic(render_kwargs_train['network_fine']) * 0.5
        unit_exp_loss0 = point_constraint_synthetic(render_kwargs_train["network_fn"]) * 0.5
        ...
        if i%args.i_testset==0 and i > 0:
            ...
            draw_CRF(testsavedir + "_novel", render_kwargs_test['network_fine'])
