...
def train():
    ...
    if args.dataset_type == 'ellff':
        ...
        exp_times_test[0] = exp_times_test[0] / 4
        exp_times_test[1] = exp_times_test[0] / 2
        exp_times_test[3] = exp_times_test[0] * 2
        exp_times_test[4] = exp_times_test[0] * 4
